...
export type { YouTubeVideo, AuthStatus, QuotaInfo, UploadHistoryEntry, UploadProgress, ScheduledUpload };

type RawScheduledUpload = Omit<ScheduledUpload, 'status' | 'error' | 'schedule'> & {
...
const normalizeScheduledUpload = (item: RawScheduledUpload): ScheduledUpload => ({
  ...item,
