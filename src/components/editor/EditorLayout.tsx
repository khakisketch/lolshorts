      ...
      <div className="flex flex-col h-full overflow-hidden md:hidden">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex flex-col h-full">
          ...
          <div className="flex-1 overflow-hidden">
            ...
            <TabsContent value="effects" className="h-full m-0 data-[state=active]:flex data-[state=active]:flex-col">
              <div className="flex-1 overflow-y-auto bg-card">
                {effectsPanel}
              </div>
            </TabsContent>
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <aside className="w-72 lg:w-80 border-l bg-card overflow-hidden flex-shrink-0 flex flex-col">
            ...
            >
              ...
              <TabsContent value="composition" className="flex-1 overflow-y-auto m-0 data-[state=active]:flex data-[state=active]:flex-col">
                {compositionSettings}
              </TabsContent>
              <TabsContent value="effects" className="flex-1 overflow-y-auto m-0 data-[state=active]:flex data-[state=active]:flex-col">
                {effectsPanel}
              </TabsContent>
            </Tabs>
          </aside>
