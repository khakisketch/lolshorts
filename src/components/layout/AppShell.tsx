...
function getAppWindow() {
  if (!appWindow) {
    try { appWindow = getCurrentWindow(); } catch { /* non-Tauri env */ }
  }
  return appWindow;
}
...
export function AppShell({ children }: AppShellProps) {
  ...
  return (
    <div data-testid="app-shell" className="flex h-screen w-screen overflow-hidden">
      ...
      {mobileMenuOpen && (
        <>
          ...
          />
          <div id="mobile-sidebar" className="md:hidden fixed inset-y-0 left-0 z-50 w-64">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main id="main-content" className="flex-1 overflow-y-auto bg-background relative" role="main">
          {/* Grid Background Pattern */}
          <div className="absolute inset-0 gaming-grid-bg pointer-events-none" aria-hidden="true" />
