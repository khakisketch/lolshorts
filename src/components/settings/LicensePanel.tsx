                    ...
                    {isActive ? (
                      ...
                      <>
                        ...
                        <span className="font-medium">
                          {license.status === 'none' ? t('settings.license.inactive') : license.status}
                        </span>
                      </>
                    )}
                  </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {[
                      ...
                      { key: 'prioritySupport', descKey: 'prioritySupportDesc' },
                      { key: 'noWatermarks', descKey: 'noWatermarksDesc' },
                    ].map(({ key, descKey }) => (
                      <div key={key} className="flex items-start gap-2">
                        <CheckCircle2 className="w-4 h-4 text-gaming-cyan mt-0.5 flex-shrink-0" />
                        <div>
                          <p className="font-medium text-sm">{t(`settings.license.features.${key}`)}</p>
                          <p className="text-xs text-muted-foreground">{t(`settings.license.features.${descKey}`)}</p>
                        </div>
                      </div>
                    ))}
                  </div>
