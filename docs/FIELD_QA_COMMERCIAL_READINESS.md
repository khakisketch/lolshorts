...
| Supabase quota tests         | Deno ran 8 quota and entitlement logic tests with 8 passed / 0 failed on 2026-08-21. Static preflight checks cover the ordered migration chain; database-level pgTAP tests are the current RLS/privilege gate.                                                                                                                             | Local automated verification | Does not prove that migrations are applied to the production project                                                                                                |
