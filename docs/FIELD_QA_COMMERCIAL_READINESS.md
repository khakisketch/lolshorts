...
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Frontend aggregate gate     | Not rerun as a single command on 2026-05-05; component commands below were run separately                                                                                                                    | Local automated verification | Confirms the frontend gate script wiring only when run directly                                                                                                     |
| Frontend lint               | `npm run lint` passed with no warnings on 2026-05-05                                                                                                                                                         | Local automated verification | Supports code hygiene only                                                                                                                                          |
| TypeScript typecheck        | `npm run typecheck` passed on 2026-05-05                                                                                                                                                                     | Local automated verification | Confirms frontend types only                                                                                                                                        |
| Frontend build              | `npm run build` passed on 2026-05-05                                                                                                                                                                         | Local automated verification | Confirms packaged frontend can compile                                                                                                                              |
| Jest unit/integration tests | `npm run test:unit` passed 23 suites / 243 tests on 2026-05-05; existing React `act(...)` console warnings and expected error logs remain test-noise to track separately                                     | Local automated verification | Confirms mocked and unit behavior only                                                                                                                              |
| Rust check/tests            | `cargo check` passed on 2026-05-05; `cargo test` passed on 2026-05-05 with 375 unit tests + integration/doc tests passing and ignored hardware-heavy tests unchanged                                         | Local automated verification | Confirms backend compile and unit behavior only                                                                                                                     |
...
Do not configure live Toss keys, paid plans, subscription enforcement, or production payment webhooks during this checklist. Payment work can start only after the release owner confirms every field-only row has passing evidence, every blocker has an issue or fix, rollback has been tested, and legal or account setup requirements are complete.
