...
> **2026-09-03 병렬 감사 추가분 (HEAD `3c84812`):** "조용히 그 판을 통째로 날리는"
> 사일런트 버그 6건(G001~G006, G012) + 피드백/관측 5건(G007~G011)을
> [PRE_E5_HARDENING_SPEC.md](./PRE_E5_HARDENING_SPEC.md)에 구체 스펙으로 편입. 원장 = `.ksi/`.
> 아래 E4-*/UX-*/OBS-* 항목과 병행한다.
